...
<body>
   ...
   <table border="1" bordercolor="white" width="90%" height="900px"  style="align-content:center; margin-left:auto; margin-right:auto; border-left: none; border-right: none; border-bottom: none">
      ...
      <tr>
      <td><a href="/web/GuestReviewSelect?id=${squad.members_id}"><img src="/web/resources/img/play/upload/profile/${squad.members_profile_img}" style="width: 255px; height: 255px; margin-top: 30px;" /></a></td>
      <td>
